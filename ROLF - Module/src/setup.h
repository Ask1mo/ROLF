...
#define SERVER_IP "192.168.137.105" //Should be Static IP of the master
//Wifi & UDP
...
#define SELECTEDPRESET PRESET_254_STRIJP_HORNLONG //This is where you select the type15 of pipe you're using
